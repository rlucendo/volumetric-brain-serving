...
class HealthResponse(BaseModel):
    ...
    model_loaded: bool = Field(..., description="Indicates if the inference engine is ready in memory")
...
class PredictionMetrics(BaseModel):
    ...
    tumor_volume_mm3: float = Field(..., description="Total volume of the predicted tumor in cubic millimeters")
